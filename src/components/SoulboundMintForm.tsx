    ...
    <div className="grid lg:grid-cols-2 gap-16 lg:gap-[8vw]">
      ...
      <div className="space-y-12 lg:pt-0">
        ...
        <div className="bg-black/5 p-6">
          <p className="font-tomorrow text-[10px] tracking-[0.15em] text-black/60 uppercase mb-2">Soulbound Token</p>
          <p className="font-tektur text-black/50 text-sm leading-relaxed">
            This token is non-transferable and bound to your wallet forever. You can burn it if you no longer want it.
          </p>
        </div>
            ...
            <>
              ...
              >
                {isLoading ? (
                  ...
                  <span className="font-tomorrow">Mint Soulbound</span>
                )}
              </button>
